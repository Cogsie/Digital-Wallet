export default {
    clients: [{
      client_id: 'foo',
      client_secret: 'bar',
      redirect_uris: ['https://oidcdebugger.com/debug', 'http://127.0.0.1:5500/Backend/RelyingParty/mock.html','http://127.0.0.1:5500/Frontend/get_verified.html'], //https://oidcdebugger.com/debug for debugging
      scope: 'openid',
      response_types: ['code'], //Information that is responded
      grant_types: ['authorization_code'],
      // ... other client properties (https://github.com/panva/node-oidc-provider/blob/HEAD/docs/README.md#configuration-options)
    }],
  jwks: { //Needs to be changed
      keys: [{
          "kty": "RSA",
          "alg": "RS256",
          "use": "sig",
  ...
  features: {
      ...
      claims: {
          profile: ['IssuingID', 'IssuingName', 'Grade', 'StudentID', 'StudentFName', 'StudentLName', 'IssueDateTime']
        },
  }